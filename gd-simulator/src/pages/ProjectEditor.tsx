...
export function ProjectEditor() {
  ...
  return (
    <div className="p-6 max-w-4xl mx-auto">
      ...
      {/* Import warnings — UC consolidation / REN 1095/24 renumbering (documented from upload) */}
      {project.importWarnings && project.importWarnings.length > 0 && (
        <div className="mb-4 rounded-lg border border-amber-300 bg-amber-50 px-3 py-2">
          <div className="text-xs font-semibold text-amber-900 mb-1">📄 Notas da importação de faturas</div>
          <div className="space-y-1">
            {project.importWarnings.map((w, i) => (
